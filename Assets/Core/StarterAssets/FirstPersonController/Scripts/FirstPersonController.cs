...
namespace StarterAssets {
    ...
    public class FirstPersonController : MonoBehaviour {
        ...
        public void HandleOnTriggerEnter(Collider other) {
            _playerInteractor.HandleOnTriggerEnter(other);
        }

        public void HandleOnTriggerExit(Collider other) {
            _playerInteractor.HandleOnTriggerExit(other);
        }
        ...
        private void Interact() {
            if (_input.interact) {
                ...
                // set interact to false b/c input has been received
